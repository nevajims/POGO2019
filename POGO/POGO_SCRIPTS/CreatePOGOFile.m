...
%TODO stretch in z direction

PATH = 'POGO_SCRIPTS\';
INFILE = 'temp.vtu';
OUTFILE = 'example2.pogo-inp';
...
%load in mesh
m = loadVtuMesh(strcat(PATH, INFILE) );
...
%can ignore above as simply modifying the mesh
...
savePogoInp(strcat(PATH, OUTFILE),m3);