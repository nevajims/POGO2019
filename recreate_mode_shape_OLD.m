function new_model_def = recreate_mode_shape_OLD(model_def, N_cycles ,chosen_freq,reshaped_proc_data,mode_no,whichFrame,sigType)

% up to date version is in   ----------    setup_pogo_model 
